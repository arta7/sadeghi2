...
<View style={{width:wp('100%'),height:hp('35%')}}>
        ...
        />
            ...
            <View style={{justifyContent:'center',alignItems:'center',marginTop:'10%',paddingHorizontal:wp(4),
           }}>
    ...
    color: "red",
    fontSize: wp(3),padding:10}}>این ارزیابی ها نباید در زنان باردار یا شیرده،ورزشکاران و کسانی که استخوان بندی درشت دارند و افراد خیلی قد بلند و کوتاه استفاده شود.</Text>
     </View>
      ...
      <View style={{flexDirection:"row-reverse",justifyContent:'center',flexWrap:'wrap',alignItems:'center',alignSelf:'center',width:wp(90),marginHorizontal:wp(5)}}>

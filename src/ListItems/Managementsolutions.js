...
import {ManagementsolutionsList} from './../Control/Data';
...
export default Managementsolutions = (props) => {
    ...
    return (
      ...
      textAlign: 'right'}}>راهکارهای خود مدیریتی عوارض</Text>
            </View>
            <View style={{ width: wp('15%'), alignItems: 'center', justifyContent: 'center' }}>
        ...
        <FlatList
            data={ManagementsolutionsList}
            renderItem={({item,index}) =>  
                    <TouchableOpacity style={{width:wp(90),height:hp(12),marginHorizontal:wp(5)
                  
                    ,marginVertical:10,flexDirection:'row',marginHorizontal:wp(5),justifyContent:'space-between'
                    ,borderBottomWidth:0.4,borderBottomColor:'grey'}}
